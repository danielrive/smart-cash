...
func LoadConfig() (*Config, error) {
	...
	cfg := &Config{
		...
		ExpensesServiceURL: getEnv("EXPENSES_SERVICE_URL", "http://expenses.develop.svc.cluster.local:8282"),
		BankServiceURL:     getEnv("BANK_SERVICE_URL", "http://bank.develop.svc.cluster.local:8585"),
		PaymentServiceURL:  getEnv("PAYMENT_SERVICE_URL", "http://payment.develop.svc.cluster.local:8989"),
