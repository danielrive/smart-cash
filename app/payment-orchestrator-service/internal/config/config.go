...
func LoadConfig() (*Config, error) {
	...
	cfg := &Config{
		...
		ExpensesServiceURL: getEnv("EXPENSES_SERVICE_URL", "http://expenses-service.develop.svc.cluster.local:8282"),
		BankServiceURL:     getEnv("BANK_SERVICE_URL", "http://bank-service.develop.svc.cluster.local:8585"),
		PaymentServiceURL:  getEnv("PAYMENT_SERVICE_URL", "http://payment-service.develop.svc.cluster.local:8989"),
